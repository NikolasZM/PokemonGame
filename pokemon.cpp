...
void crearInicial(string archivoData) {
  ...
  while (getline(archivo, linea)) {         //Crear iniciales
    ...
    string id,especie,tipo1,tipo2,vida,ataque,defensa;
    ...
    if (id=="1"||id=="4"||id=="7") {
        ...
        inicial[i].setInfo(especie,5,vidaInt,ataqueI,defensaI,tipo1,tipo2);
        inicial[i].getInfo();
        i++;
    }else {
        continue;
...
cout<<"Estos son nuestros pokemons iniciales:\n";
